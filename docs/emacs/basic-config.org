...
*** Fonts
Currently rocking [[https:jetbrains.com/lp/mono/][JetBrains Mono]] across most things
#+begin_src emacs-lisp
(defvar anlu/default-font-size 140
  "Default font size.")

(defvar anlu/default-font-name "JetBrains Mono"
  "Default font.")

(defun my/set-font ()
  (when (find-font (font-spec :name anlu/default-font-name))
    (set-face-attribute 'default nil
                        :font anlu/default-font-name
                        :height anlu/default-font-size)))
